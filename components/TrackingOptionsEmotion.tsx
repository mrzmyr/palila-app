...
export default function TrackingOptionsEmotion({ trackingSymptoms, setTrackingSymptom }) {
  ...
  return (
    ...
    <Headline
      ...
      level={3}
    >{t('common_tracking_option_emotion_headline')}</Headline>
    <View style={{ flexDirection: "row", width: "100%", paddingLeft: 20, paddingRight: 20 }}>
      <TrackingOptionButton
        label={t(`common_tracking_option_emotion_1`)}
      ...
      />
      <TrackingOptionButton
        label={t(`common_tracking_option_emotion_2`)}
    ...
    <View style={{ flexDirection: "row", width: "100%", paddingLeft: 20, paddingRight: 20 }}>
      <TrackingOptionButton
        label={t(`common_tracking_option_emotion_3`)}
      ...
      />
      <TrackingOptionButton
        label={t(`common_tracking_option_emotion_4`)}
